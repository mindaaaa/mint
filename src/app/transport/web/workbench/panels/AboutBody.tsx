  ...
  return (
    <div className="px-5 py-5 overflow-y-auto h-full">
      ...
      <p className="font-serif text-[13.5px] text-workbench-ink-soft leading-[1.8] mt-5 m-0">
        MINT는 식물의 생애주기를 따라 지어진 작은 언어입니다.
        씨앗을 심고, 바람이 스쳐 지나가고, 꽃이 피어나는 동안
        프로그램이 자라요.
      </p>
      ...
      <div className="mt-5 grid grid-cols-[auto_1fr] gap-x-4 gap-y-2 font-mono text-[11.5px] leading-[1.5]">
        ...
        <span className="text-workbench-ink-soft font-serif italic">이름을 심어요</span>
        <span className="text-workbench-amber">sparkle</span>
        <span className="text-workbench-ink-soft font-serif italic">소리 내어 읽어요</span>
        <span className="text-workbench-plum">breeze</span>
        <span className="text-workbench-ink-soft font-serif italic">조건이 스쳐 지나가요</span>
        <span className="text-workbench-clay">bloom</span>
        <span className="text-workbench-ink-soft font-serif italic">반복해 피워요</span>
        <span className="text-workbench-clay">petal</span>
        <span className="text-workbench-ink-soft font-serif italic">꽃잎처럼 함수를 접어요</span>
        <span className="text-workbench-green-deep">gift</span>
        <span className="text-workbench-ink-soft font-serif italic">값을 건네요</span>
      </div>
      ...
      <div className="mt-6 font-mono text-[10px] text-workbench-ink-faint tracking-[0.5px]">
        set in IBM Plex Serif &amp; IBM Plex Mono · spring 2026
      </div>
    </div>
  );
}
